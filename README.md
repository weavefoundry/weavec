...
Heap inference currently increases false positives on Lua’s GC and callback
patterns; the [corpus notes](scripts/corpus/README.md#rfc-0013-heap-state-and-allocation-time-values)
record that precision cost.
