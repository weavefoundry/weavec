...
static constexpr std::array RequirementFields{
...
static constexpr std::array DeclaredFields{
    ...
    scalar("ownership", String, true)};
/// §13.2 step 5: what the caller knows about one argument.
static constexpr std::array EvidenceFields{
    scalar("bytes", Integer, true), scalar("exact", Boolean),
    scalar("null", Boolean), scalar("value", Integer, true)};
