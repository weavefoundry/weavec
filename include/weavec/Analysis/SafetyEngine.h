...
struct EngineInput {
  ...
  /// §9.3: the unit's slot constraints and their solution, kept alive with
  /// the kinds (stage S7 consumes them); null without them.
  const SlotCollection *slotCollection = nullptr;
