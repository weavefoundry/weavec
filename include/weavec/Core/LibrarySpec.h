...
/// RFC 0030 §8.2: the number of variadic arguments a literal `printf`
/// (`kind` Printf) or `scanf` format reads, `*` widths and precisions
/// included; nothing for a format with positional (`%1$d`) conversions or a
/// malformed one.
