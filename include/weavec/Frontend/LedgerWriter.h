...
//
// Two keys go beyond the §12.1 example: every summary carries
// `verifyChecks` (the proven facets that received a verify check, §10.7)
// when `config.checks` is `verify`, and a `fixit` is the object
