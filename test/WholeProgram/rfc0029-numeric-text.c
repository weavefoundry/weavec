// RUN: %weavec --checked-function=main %S/../evaluation/rfc0029/numeric-text/stores.c --
// RUN: not %weavec --checked-function=main %S/../evaluation/rfc0029/numeric-text/nan.c -- 2>&1 | FileCheck %s
