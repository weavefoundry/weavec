...
// Section 7.5: the dereference in a static callee is a must-access, so its nonnull check
// moves to the callee's direct calls, which are rewritten before the callee is defined.
