...
int scan(struct reader *r) {
 ...
 if(r->capacity>=3){unsigned char *p=(unsigned char*)r->data;p[0]='n';p[1]='a';p[2]='n';}
...
int main(void){unsigned char input[]="111";struct reader r={input,0,sizeof input,0};return scan(&r);}
