...
// findings are warnings, and leaves its definite errors.
...
// RUN: %weavec_cc -### -fno-weavec-zero-init -Wno-weavec-annotation-required -c %s -o %t/x.o 2>&1 | FileCheck --check-prefix=JOBS %s
...
// JOBS-SAME: "-fno-weavec-zero-init" "-Wno-weavec-annotation-required"
// JOBS-NOT: error:
